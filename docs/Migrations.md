...
- 已添加本地 `dotnet-ef` 工具清单：[`.config/dotnet-tools.json`](../.config/dotnet-tools.json)。
- 已生成初始 Migration：[`StudentsManagerSystem/Data/Migrations/20260611070354_InitialCreate.cs`](../StudentsManagerSystem/Data/Migrations/20260611070354_InitialCreate.cs)。
...
- 默认数据仍集中维护在 [`DatabaseInitializer`](../StudentsManagerSystem/Data/DatabaseInitializer.cs#L14)。
